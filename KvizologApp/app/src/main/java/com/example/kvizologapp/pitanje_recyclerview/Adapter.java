package com.example.kvizologapp.pitanje_recyclerview;
...
import com.example.kvizologapp.MainActivity;
...
public class Adapter extends RecyclerView.Adapter<com.example.kvizologapp.pitanje_recyclerview.Adapter.ViewHolder> {
    ...
    private com.example.kvizologapp.pitanje_recyclerview.Adapter.OnItemClickListener listener;
    ...
    public Adapter(List<Igra_ima_Pitanje> items, com.example.kvizologapp.pitanje_recyclerview.Adapter.OnItemClickListener listener) {
        this.items = items;
    ...
    @Override
    public com.example.kvizologapp.pitanje_recyclerview.Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // creating a new view-a
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.pitanje_card, parent, false);
        com.example.kvizologapp.pitanje_recyclerview.Adapter.ViewHolder vh = new com.example.kvizologapp.pitanje_recyclerview.Adapter.ViewHolder(v);
        return vh;
    }

    // setting content inside view-a (invoked by the layout manager)
    @Override
    public void onBindViewHolder(com.example.kvizologapp.pitanje_recyclerview.Adapter.ViewHolder holder, final int position) {
