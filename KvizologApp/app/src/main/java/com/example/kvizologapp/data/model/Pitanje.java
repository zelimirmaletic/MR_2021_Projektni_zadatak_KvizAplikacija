...
public class Pitanje implements Serializable {
    ...
    public static Pitanje[] populateData() {
        return new Pitanje[] {
                ...
                new Pitanje(0,"Russia","Moscow","London","Kiev","Vladivostok", "Русија","Москва","Лондон","Кијев","Владивосток", "Moscow","Москва","Red square","Црвени трг","NO_IMAGE"),
                new Pitanje(0,"Slovenia","Maribor","Ljubljana","Skopje","Belgrade", "Словенија","Марибор","Љубљана","Скопље","Београд", "Ljubljana","Љубљана","Dragon is the most recognizable symbol.","Најпрепознатљивији сибол града је змај.","NO_IMAGE"),
                new Pitanje(0,"Serbia","Skopje","Belgrade","Novi Sad","Trebinje","Србија","Скопље","Београд","Нови Сад","Требиње","Belgrade","Београд","Biggest orthodox church in the Balkans","Највећа православна црква на Балкану","NO_IMAGE"),
                ...
                new Pitanje(0,"Germany", "Hamburg","Berlin","Hanover","Munch","Њемачка","Хамбург","Берлин","Минхен","Хановер","Berlin","Берлин","Used to be divided by a wall.","Био је подијељен зидом.","NO_IMAGE"),
                new Pitanje(0,"Greece","Heraklion","Athens","Thessaloniki","Berlin","Грчка","Херклион","Атина","Тесалоники","Берлин","Athens","Атина","Partenon","Партенон","NO_IMAGE"),
                new Pitanje(0,"","","","","","","","","","","","","","",""),
                new Pitanje(0,"","","","","","","","","","","","","","",""),
                new Pitanje(0,"","","","","","","","","","","","","","",""),
                new Pitanje(0,"","","","","","","","","","","","","","",""),
                ...
                new Pitanje(1,"","BHUTAN","","","","БУТАН","","","","","","","","","ic_bhutan"),
                ...
                new Pitanje(1,"","BANGLADESH","","","","БАНГЛАДЕШ","","","","","","","","","ic_bangladesh"),    new Pitanje(4,"","BOSNIA AND HERZEGOVINA","","","","БОСНА И ХЕРЦЕГОВИНА","","","","","","","","","ic_bih"),
                new Pitanje(1,"","BRAZIL","","","","БРАЗИЛ","","","","","","","","","ic_brazil"),
                new Pitanje(1,"","CANADA","","","","КАНАДА","","","","","","","","","ic_canada"),
                new Pitanje(1,"","CHAD","","","","ЧАД","","","","","","","","","ic_chad"),
                new Pitanje(1,"","CHINA","","","","КИНА","","","","","","","","","ic_china"),
                new Pitanje(1,"","DENMARK","","","","ДАНСКА","","","","","","","","","ic_denmark"),
                new Pitanje(1,"","KYRGYZSTAN","","","","КИРГИСТАН","","","","","","","","","ic_kyrgyzstan"),
                new Pitanje(1,"","NORTH MACEDONIA","","","","СЈЕВЕРНА МАКЕДОНИЈА","","","","","","","","","ic_north_macedonia"),
                new Pitanje(1,"","PAPA NEW GUINEA","","","","НОВА ГВИНЕЈА","","","","","","","","","ic_papa_new_guinea"),
                new Pitanje(1,"","RUSSIA","","","","РУСИЈА","","","","","","","","","ic_russia"),
                new Pitanje(1,"","SWITZERLAND","","","","ШВАЈЦАРСКА","","","","","","","","","ic_switzerland"),
                new Pitanje(1,"","UNITED KINGDOM","","","","ВЕЛИКА БРИТАНИЈА","","","","","","","","","ic_uk"),
                new Pitanje(1,"","VIETNAM","","","","ВИЈЕТНАМ","","","","","","","","","ic_vietnam"),
                new Pitanje(1,"","YEMEN","","","","ЈЕМЕН","","","","","","","","","ic_yemen"),
